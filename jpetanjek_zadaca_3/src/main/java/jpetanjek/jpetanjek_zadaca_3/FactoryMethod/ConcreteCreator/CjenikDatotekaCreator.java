...
import jpetanjek.jpetanjek_zadaca_3.FactoryMethod.ConcreteProduct.CjenikDatotekaProduct;
 ...
 */
public class CjenikDatotekaCreator implements DatotekaCreator {

    @Override
    public DatotekaProduct makeProduct() {
        return new CjenikDatotekaProduct();
    }
}